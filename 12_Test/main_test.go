...
func TestDivide(t *testing.T) {
	...
	if err != nil { // If there is an error from main.go, then something went wrong
...
func TestBadDivide(t *testing.T) {
	_, err := divide(10.0, 0)
	if err == nil { // If there is NO error from main.go, then something went wrong
